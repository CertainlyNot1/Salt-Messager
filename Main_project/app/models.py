...
class MSG(db.Model):
    ...
    message_type = db.Column(db.String(10), default='text')  # 'text', 'photo', 'audio'
    media_url = db.Column(db.String(255))  # Path to media file
    mime_type = db.Column(db.String(50))  # MIME type for media
